...
if __name__ == "__main__":
    batch_size = 8
    log_epoch = 2
    class_num = 40 #攻击模型的输入特征数量 真+假
    root_dir = r"C:\Users\ADMIN\lpl\MIA\logs.attack"
    dataset_dir = r"C:\Users\ADMIN\lpl\at&t face database"
    target_pkl = r"C:\Users\ADMIN\lpl\MIA\logs\Model_2024Jun24_03-29-17_ADMIN-20240528F_main AT and T face\defended_model_part_0.pkl"
    h = 112
    w = 92
    alpha = 50000
    beta = 1000
    ...
    checkpoint = torch.load(open(target_pkl, "rb"), map_location=output_device)
    mynet.load_state_dict(checkpoint['model_state_dict'])
    mynet.order_mapping = checkpoint['order_mapping']
